...
namespace VijayAnand.MauiTemplates
{
    internal sealed partial class Vsix
    {
        ...
        public const string Description = @".NET MAUI Project, Item Templates, and Code Snippets for Visual Studio 2022 and 2026 Insiders (.NET MAUI 8, 9, and 10).";
        public const string Language = "en-US";
        public const string Version = "7.13.0.0";
