...
echo .NET MAUI ContentPage with BlazorWebView (C#)
echo.
...
if "%options%"=="_" (dotnet new maui-bwv-cs -n %item_name%) else (if "%options:~0,1%"=="-" (dotnet new maui-bwv-cs -n %item_name% %options% %~3 %~4 %~5 %~6) else (echo Invalid input.))
