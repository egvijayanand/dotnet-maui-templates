# .NET MAUI ContentPage and ViewModel (XAML) Template
...
if ($SameFolder)
{
    if ($Force)
    {
        Invoke-Expression "dotnet new maui-mvvm -n $Name -sf --force"
    }
    else
    {
        Invoke-Expression "dotnet new maui-mvvm -n $Name -sf"
    }
}
else
{
    if ($Force)
    {
        Invoke-Expression "dotnet new maui-mvvm -n $Name --force"
    }
    else
    {
        Invoke-Expression "dotnet new maui-mvvm -n $Name"
    }
}
