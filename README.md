...
|Stable|[.NET 10 SR3.1](https://github.com/dotnet/maui/releases/tag/10.0.31 "Changelog") (10.0.31) <br /> [Release Notes](https://github.com/dotnet/core/blob/main/release-notes/10.0/10.0.0/dotnetmaui.md) <br /> _Requires JDK 17 and Android SDK 36_ <br /> _Requires Apple Xcode 26_|VS2026 18.x|Tue, Feb 3, 2026|Active|
